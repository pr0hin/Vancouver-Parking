...
public class MeterCell extends AbstractCell<MeterInfo> {
	...
	interface MeterCellTemplates extends SafeHtmlTemplates {
		...
		@SafeHtmlTemplates.Template("<div class='cell'>"
				...
				+ "</div>")
		SafeHtml cell(long meterNum, double rate, String paymentType,
				String iconStyle, double timeStart, double timeEnd,
				int timeLimit);
	}
	...
	public void render(com.google.gwt.cell.client.Cell.Context context,
		...
		// This next line needs to be an if statement that checks some info on
		// meter and
		...
		SafeHtml rendered = templates.cell(meterNum, rate, paymentType,
				iconStyle, start, end, limitVal);
		sb.append(rendered);
